#####################################
# This code is done by Nader Albaire & Ishtiag Abbaker
# Breadth First Search / Flood fill
# ALX SE foundation Project
# 31.May.2024
#####################################
...
wn.title("A Maze Solver Program")
...
# this is the class for the red or turtle
...
def setup_maze(grid):                          # define a function called setup_maze
    ...
    for y in range(len(grid)):                 # read in the grid line by line
        for x in range(len(grid[y])):          # read each cell in the line
            character = grid[y][x]             # assign the variable "character" to the x and y location of the grid
